...
namespace CshorpStudy
{
    ...
    public class MySqlHelper
    {
        ...
        /// <summary>
        /// 执行查询语句，返回DataSet,设置命令的执行等待时间 static
        /// </summary>
        /// <param name="SQLString"></param>
        /// <param name="Times"></param>
        /// <returns></returns>
    ...
    namespace CshorpStudy
    {
        ...
        public class MySqlHelper
        {
            ...
            public MySqlHelper(string server, string db, string uid, string pwd)
            {
                connectionString = "server=" + server + ";database=" + db + ";uid=" + uid + ";pwd=" + pwd + ";charset=gbk";
                MySqlConnection mySqlConn = new MySqlConnection(connectionString);
            }
